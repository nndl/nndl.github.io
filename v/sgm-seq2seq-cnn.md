...
<figure class="viz-figure viz-figure--wide">
  <img src="{{ '/v/sgm-seq2seq-fnn-wavenet.gif' | relative_url }}" alt="WaveNet 空洞因果卷积" loading="lazy">
...
<figure class="viz-figure viz-figure--wide">
  <img src="{{ '/v/sgm-seq2seq-cnn-mt.gif' | relative_url }}" alt="基于 CNN 的 Seq2Seq" loading="lazy">
