...
var SVGNS="http://www.w3.org/2000/svg",W=460,H=220,pl=16,pr=16,XR=6;
...
function draw(){
  ...
  [-6,-4,-2,0,2,4,6].forEach(function(t){E(svg,"text",{x:wx(t),y:H-5,"text-anchor":"middle","class":"alab"}).textContent=t;});
